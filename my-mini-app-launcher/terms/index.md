...
- The legality of the HTML files you upload, including any code, images, fonts, scripts, or other content embedded within them.
- Ensuring you have the necessary rights and licences to use that content.
- The behaviour of any scripts or external resources referenced from your HTML files when rendered by your browser.
