...
- Reverse engineer, decompile, or attempt to extract the source code of the Extension except to the extent expressly permitted by applicable law.
- Sell, rent, sublicence, or commercially redistribute the Extension or modified copies of it.
- Use the Extension to violate any law, infringe any third party's rights, or distribute malware.
...
The FAQ entries, categories, tags, and CSV files you create, import, or export remain yours. You retain all rights to that content. We do not receive copies of, access, or take any rights in your content; it remains on your device.

You are solely responsible for:

- The legality of the content you store in the Extension.
- Ensuring you have the necessary rights and licences for any content you import from a CSV file.
- Backing up your own data using the Extension's Export CSV feature.

You must not use the Extension to store or distribute content that is illegal, infringing, malicious, harmful, or that violates the rights of others.

---

## 4. No warranty

The Extension is provided **"as is" and "as available"**, without warranty of any kind, express or implied, including without limitation any warranties of merchantability, fitness for a particular purpose, non-infringement, accuracy, reliability, or that the Extension will be uninterrupted, error-free, or free of data loss. To the maximum extent permitted by law, we disclaim all such warranties.
...
Your use of the Extension is also subject to our [Privacy Policy](https://clickpopme.github.io/clickpopme-legal/simple-faq/privacy/), which forms part of these Terms. The Extension does not collect, transmit, or share your data; all entries are stored locally on your device.
